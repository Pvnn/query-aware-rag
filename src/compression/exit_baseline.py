...
class ExitBaselineCompressor:
	...
	def compress_with_stats(self, query, document):
		"""
		Compress document and return detailed statistics.
		
		Returns:
			dict with compressed_text, original_length, compressed_length, 
			compression_ratio, sentences_kept, sentences_total
		"""
		sentences = self.decompose_sentences(document)
