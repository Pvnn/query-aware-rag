...
def test_pipeline():
    ...
    # This reflects the total tokens processed by your local GPU models
    print(f"  - Local Compute Cost:    {comp['hf_tokens_cost']} HF tokens")

    print(f"\n💳 API Usage & Cost:")
    # Updated to match: result['metrics']['usage']['compressed_api_tokens']
    ...
    if pipeline.use_fine:
      # Deep dive into the EP-EXIT stats (Rich Logs)
